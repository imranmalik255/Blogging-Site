...
if (isset($_POST['submit']) && isset($_FILES['image'])) {
    ...
    $time = date('h:i A');
    $date = date('d/m/y');
    $query2 = "INSERT INTO `Blogs` (BlogTitle, BlogDescription, BlogImagePath, BlogTime, BlogDate)
    VALUES ('$title', '$description', '$image_path', '$time', '$date')";
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item" style='border-bottom: 3px solid white;'>
                        <a class="nav-link active text-white" aria-current="page" href="Adminaddblog.php">Add Blog</a>
                    </li>
                </ul>
    ...
    <section id="contact">
        <div class="container custom-size-laptop-container custom-size-mobile-container">
            <h3 class="text-center mt-5 mb-5 bg-danger p-2 text-white">Add Blog</h3>
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-12"><input type="text" class="w-100 p-2 fs-4 border border-danger custom-outline text-danger" placeholder="Enter the title" name="title">
                    </div>
                </div>
                <div class="row">
                    <label for="" class="text-danger fs-3 mt-3 mb-3">Description*</label>
                    <div class="col-12"><input type="text" class="w-100 p-2 fs-4 border border-danger custom-outline text-danger" placeholder="Enter the description" name="description">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12"><input type="submit" class="w-100 p-2 fs-4 border border-none text-white" style="background-color: black; color: white; margin-top: 10px; margin-bottom: 10px;" name="submit" value="Add Blog">
                    </div>
                </div>
            </form>
        </div>
