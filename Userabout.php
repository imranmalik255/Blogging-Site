...
<body>
    ...
    <div style="margin-bottom: 10px;">
        <nav class="navbar navbar-expand-lg navbar-light bg-dark" id="navbar-border">
            ...
            <a class="navbar-brand profile-margin text-white" href="Userhome.php">Imran Malik</a>
            ...
            <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item custom-width">
                        <a class="nav-link active text-white" href="Userabout.php" style='border-bottom: 3px solid white;'>About</a>
                    </li>
                    <li class="nav-item">
    ...
    <section>
        ...
        <h3 class="fs-1 text-md-center mt-5 mb-5 bg-danger p-2 text-white">About</h3>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-12" style="display: flex; align-items: center; justify-content: center;">
                    <img src="Images/About-image.png" alt="" width="100%" height="300" class="mb-5">
                </div>
                <div class="col-md-6 col-12 d-flex">
                    <h1 style="font-weight: bold;"><span class="text-danger" style="font-size: 10vw; font-weight: bolder;">H</span>ey my name is
                        Imran Malik, I am from BahawalPur. I have graduated from University of Management and Technology
                        Lahore. <br> <br> <br> I am a <span class="bg-danger p-1 rounded text-white">Software
                            Engineer</span> who
                        works in
                        WEB
            ...
            <div class="row mb-5">
                ...
                <div class="col-2" style="display: flex; align-items: center; justify-content: center;">
                    <img src="Images/close.png" alt="" height="50" width="50" class="image-fluid">
                </div>
                <div class="col-5" style="display: flex; align-items: center; justify-content: center;">
                    <div class="custom-hr"></div>
                </div>
